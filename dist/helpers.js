...
function esConfigLoader(_x) {
  return _esConfigLoader.apply(this, arguments)
}
function _esConfigLoader() {
  _esConfigLoader = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime.mark(function _callee(filepath) {
...
function tsConfigLoader(_x2) {
  return _tsConfigLoader.apply(this, arguments)
}
function _tsConfigLoader() {
  _tsConfigLoader = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime.mark(function _callee2(filepath) {
      var outfile, config
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch ((_context2.prev = _context2.next)) {
            case 0:
              outfile = filepath + '.bundle.mjs'
              _context2.next = 3
              return build({
                ...
                sourcemap: 'inline',
                external: [].concat(
                  _toConsumableArray(builtinModules),
                  _toConsumableArray(
                    builtinModules.map(function (mod) {
                      return 'node:' + mod
                    })
                  )
                ),
